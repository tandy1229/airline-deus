...
let s:N1 = [ '#232a32', '#C678DD', s:term_black, s:term_purple]
let s:N2 = [ '#ABB2BF', '#3E452', s:term_white, s:term_grey ]
let s:N3 = [ '#C678DD', '#232a32', s:term_purple, '' ]
...
let s:V1 = [ '#232a32', '#98C379', s:term_black, s:term_green]
let s:V2 = s:N2
let s:V3 = [ '#98C379', '#232a32', s:term_green, '' ]
...
" Errors
let s:ER = [ '#ABB2BF', '#232a32', s:term_white, s:term_black ]
